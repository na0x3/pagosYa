...
- Present work as a chronological, stateful timeline rather than a chat transcript or synthetic percentage. Every stage names its current state in text, derives completion from live store/catalog/proposal data, exposes expandable evidence, and announces meaningful updates through a live region.
