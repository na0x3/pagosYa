...
4. Replace in-process throttling with shared durable rate-limit state for multi-instance deployment, and add account-plus-IP lockout telemetry. Current global/route throttles are per process.
